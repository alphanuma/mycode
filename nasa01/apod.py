...
NASAAPI = 'https://api.nasa.gov/planetary/apod?date=' # this is our api to call
DATE = input("Enter the date your looking for")
...
def main():
    """run-time code"""
    nasaapiobj = urllib.request.urlopen(NASAAPI + DATE +MYKEY) # call the webservice
